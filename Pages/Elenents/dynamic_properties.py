...
class DynamicProperties(Methods):
    ...
    def push_dynamic_buttons(self):
        ...
        self.find_element(DynamicPropertiesLocators.LOCATOR_COLOR_CHANGE_BUTTON).click()
        self.find_element(DynamicPropertiesLocators.LOCATOR_VISIBLE_AFTER_BUTTON).click()